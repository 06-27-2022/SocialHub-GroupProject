...
@Table(name = "social") //denotes that this represents a table in our DB
public class Social {
	 ...
	 */
	@GeneratedValue(generator = "social_id_seq", strategy = GenerationType.AUTO)
	@SequenceGenerator(allocationSize = 1, name = "social_id_seq")
	private int id;
